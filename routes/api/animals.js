...
let animalsArr = [
  { _id: 1, name: "dog", age: 5 },
  { _id: 2, name: "unicorn", age: 500 },
  { _id: 3, name: "hiydra", age: 863 },
  { _id: 4, name: "iguana", age: 20 },
  { _id: 5, name: "cat", age: 1 },
];
router.get("/", (req, res) => {
  res.json(animalsArr);
});
...
if(animal) {
  ...
  res.json({msg: "animal not found"})
}
});

router.get("/getanimalsbiggerthan8", (req, res) =>{
  let selectedAnimalsArr = animalsArr.filter((item) => item.age > req.query.age);
